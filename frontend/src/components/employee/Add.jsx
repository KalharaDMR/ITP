...
const Add = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:4003/api/employee/add', formDataObj, {
                headers: {
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="employeeId" onChange={handleChange} placeholder="Member ID" className="mt-1 p-2 block w-full border border-gray-300 rounded-md" required />
                    </div>
